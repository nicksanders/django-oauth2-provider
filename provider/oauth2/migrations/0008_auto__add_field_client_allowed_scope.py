...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.allowed_scope'
        db.add_column(u'oauth2_client', 'allowed_scope',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.allowed_scope'
        db.delete_column(u'oauth2_client', 'allowed_scope')
    ...
    models = {
        ...
        u'oauth2.accesstoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'f55b5d1c6e7ebf2d8dd7090ce8a0f1d696c67c1c'", 'max_length': '255', 'db_index': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'oauth2.client': {
            'Meta': {'object_name': 'Client'},
            'allowed_scope': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'61bf3d0bfa7e33f8b859'", 'max_length': '255'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "'ba4113221b63ffaf06efb5d34ac72d8685a5c34d'", 'max_length': '255'}),
        ...
        u'oauth2.grant': {
            ...
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['oauth2.Client']"}),
            'code': ('django.db.models.fields.CharField', [], {'default': "'5f6d0df98a95cc5087746b9338f5c9d0d4a80bf3'", 'max_length': '255'}),
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 29, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'oauth2.refreshtoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'4d618260214264b7795741d4ea111e6ce88527c8'", 'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }
