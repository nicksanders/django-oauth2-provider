...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'oauth2_externaluser', (
            ...
            ('external_user_id', self.gf('django.db.models.fields.CharField')(default='f1f072531621d10dd901', unique=True, max_length=30)),
        ))
    ...
    models = {
        ...
        u'oauth2.accesstoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'c97694953995dbdb7213bd9f5a5bb5a8e079572b'", 'max_length': '255', 'db_index': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'oauth2.client': {
            'Meta': {'object_name': 'Client'},
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'25e48260b9290e390a5c'", 'max_length': '255'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "'df2284c1848edc9fdf40b6b74c478f47d7e79614'", 'max_length': '255'}),
        ...
        u'oauth2.externaluser': {
            'Meta': {'unique_together': "(('user', 'client'),)", 'object_name': 'ExternalUser'},
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['oauth2.Client']"}),
            'external_user_id': ('django.db.models.fields.CharField', [], {'default': "'bd7ec44626883720080c'", 'unique': 'True', 'max_length': '30'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'oauth2.grant': {
            ...
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['oauth2.Client']"}),
            'code': ('django.db.models.fields.CharField', [], {'default': "'302843b4e015ef05b146a7fe19a56ac14d1428f6'", 'max_length': '255'}),
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 18, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'oauth2.refreshtoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'602902776b2fb6cf5d1b5e0150da61057f70de78'", 'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }
